 ...
 */
final class Version20190608005745 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier_produit ADD produit_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_D31F28A6F347EFB ON panier_produit');
        $this->addSql('ALTER TABLE panier_produit DROP produit_id');
    }
}
